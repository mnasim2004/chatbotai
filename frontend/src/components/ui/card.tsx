...
const Card = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
    <div
      ref={ref}
      className={cn(
        'rounded-2xl p-[1px] bg-gradient-to-r from-fuchsia-500 via-amber-400 to-sky-500 shadow-xl',
        className,
      )}
      {...props}
    />
...
const CardInner = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
    <div
      ref={ref}
      className={cn('rounded-2xl bg-white/95 backdrop-blur p-6 sm:p-8', className)}
      {...props}
    />
  ),
)
